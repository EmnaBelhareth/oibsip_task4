...
public class Question2 {
    ...
    void nextPage() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("./UI/Question3UI.fxml"));
    ...
    @FXML
    void nextQuestion2(ActionEvent event) throws IOException, SQLException {
    ...
    @FXML
    void initialize() {
        assert answer1 != null : "fx:id=\"answer1\" was not injected: check your FXML file 'Question2UI.fxml'.";
        assert answer2 != null : "fx:id=\"answer2\" was not injected: check your FXML file 'Question2UI.fxml'.";
        assert answer3 != null : "fx:id=\"answer3\" was not injected: check your FXML file 'Question2UI.fxml'.";
        assert answer4 != null : "fx:id=\"answer4\" was not injected: check your FXML file 'Question2UI.fxml'.";
